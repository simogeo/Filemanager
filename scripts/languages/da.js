{
	...
	"UNABLE_TO_OPEN_DIRECTORY": "Ude af stand til at �bne mappen %s.",
	"ERROR_RENAMING_DIRECTORY": "Omd�bning af mappen %s til %s mislykkedes.",
	"ERROR_RENAMING_FILE": "Omd�bning af filen %s til %s mislykkedes.",
	"INVALID_DIRECTORY_OR_FILE": "Invalid mappe eller fil.",
	"INVALID_FILE_UPLOAD": "Invalid fil til upload: Har du valgt en fil?",
	"UPLOAD_FILES_SMALLER_THAN": "Filen er for stor, filen skal v�re mindre end %s.",
	...
	"prompt_foldername": "Skriv navnet p� den nye mappe",
	"no_foldername": "Ingen mappe var angivet.",
	"create_folder": "Opret mappe",
	"cancel": "Annull�r",
	"select_from_left": "V�lg et emne til venstre.",
	"fck_select_integration": "Funktionen 'Select' er kun brugt ved brug af FCKEditor eller CKEditor.",
	"new_filename": "Skriv et nyt navn for filen",
	"successful_rename": "Omd�bt med succes.",
	"rename": "Omd�b",
	"confirmation_delete": "Er du sikker p� du �nsker at slette filen?",
	"successful_delete": "Slettet med succes.",
	"successful_added_file": "Den nye fil blev tilf�jet.",
