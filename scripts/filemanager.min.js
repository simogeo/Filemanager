...
null;"user"==("undefined"===typeof c?"user":c)?0!=a.urlParam("config")?(c="./scripts/"+a.urlParam("config"),userconfig=a.urlParam("config")):(c="./scripts/filemanager.config.js",userconfig="filemanager.config.js"):c="./scripts/filemanager.config.js.default";a.ajax({async:!1,url:c,dataType:"json",cache:!1,success:function(a){g=a}});return g},Q=w("default"),f=w();null!==f&&delete f.version;f=a.extend({},Q,f);if(f.options.logger)var R=(new Date).getTime();HEAD_included_files=[];loadCSS=function(c){if(-1==
...
b+" -  pos : "+d+" - returned value : "+rvalue);return rvalue};var k=f.options.fileConnector||"connectors/"+f.options.lang+"/filemanager."+f.options.lang,n=f.options.capabilities||"select download rename move delete replace".split(" ");0!=a.urlParam("langCode")&&P("scripts/languages/"+a.urlParam("langCode")+".js")&&(f.options.culture=a.urlParam("langCode"));var b=[];a.ajax({url:"scripts/languages/"+f.options.culture+".js",async:!1,dataType:"json",success:function(a){b=a}});a.prompt.setDefaults({overlayspeed:"fast",
show:"fadeIn",opacity:.4,persistent:!1});var x=function(){var c=53;a.urlParam("CKEditorCleanUpFuncNum")&&(c+=60);c=a(window).height()-a("#uploader").height()-c;a("#splitter, #filetree, #fileinfo, .vsplitbar").height(c);c=a("#splitter").width()-a("div.vsplitbar").width()-a("#filetree").width();a("#fileinfo").width(c)},y=function(a,g){g="undefined"===typeof g?!0:!1;if(0==f.options.showFullPath){if("function"===typeof displayPathDecorator)return displayPathDecorator(a.replace(fileRoot,"/"));a=a.replace(fileRoot,
"/");if(50<a.length&&!0===g){var b=a.split("/");a="/"+b[1]+"/"+b[2]+"/(...)/"+b[b.length-2]+"/"}}return a},A=function(c){"grid"==c?(a("#grid").addClass("ON"),a("#list").removeClass("ON")):(a("#list").addClass("ON"),a("#grid").removeClass("ON"))},B=function(a){var b="",b="\u0160\u0161\u0110\u0111\u017d\u017e\u010c\u010d\u0106\u0107\u00c0\u00c1\u00c2\u00c3\u00c4\u00c5\u00c6\u00c7\u00c8\u00c9\u00ca\u00cb\u00cc\u00cd\u00ce\u00cf\u00d1\u00d2\u00d3\u00d4\u00d5\u00d6\u0150\u00d8\u00d9\u00da\u00db\u00dc\u00dd\u00de\u00df\u00e0\u00e1\u00e2\u00e3\u00e4\u00e5\u00e6\u00e7\u00e8\u00e9\u00ea\u00eb\u00ec\u00ed\u00ee\u00ef\u00f0\u00f1\u00f2\u00f3\u00f4\u00f5\u00f6\u0151\u00f8\u00f9\u00fa\u00fb\u00fc\u00fd\u00fd\u00fe\u00ff\u0154\u0155 '/".split(""),
...
a(this).attr("data-path"),f=a("#filetree").find('a[data-path="'+f+'"]').parent();"undefined"!==typeof f.css("background-image")&&(a(this).css("background-image",f.css("background-image")),window.clearInterval(b))})},C=function(c){a("#currentpath").val(c);a("#uploader h1").text(b.current_folder+y(c)).attr("title",y(c,!1)).attr("data-path",c);a("#newfolder").unbind().click(function(){var c=b.default_foldername,f=b.prompt_foldername+' : <input id="fname" name="fname" type="text" value="'+c+'" />',d=
{};d[b.create_folder]=!0;d[b.cancel]=!1;a.prompt(f,{callback:function(d,f){if(1!=d)return!1;var e=f.children("#fname").val();""!=e?(c=B(e),e=new Date,a.getJSON(k+"?mode=addfolder&path="+a("#currentpath").val()+"&config="+userconfig+"&name="+encodeURIComponent(c)+"&time="+e.getMilliseconds(),function(b){0==b.Code?(Y(b.Parent,b.Name),m(b.Parent),a("#filetree").find('a[data-path="'+b.Parent+'/"]').click().click()):a.prompt(b.Error)})):a.prompt(b.no_foldername)},buttons:d})})},O=function(c){a("#fileinfo button").each(function(b){0==
a(this).find("span").length&&a(this).wrapInner("<span></span>")});if(r(c,"select")){if(a("#fileinfo").find("button#select").click(function(){D(c)}).show(),window.opener||window.tinyMCEPopup)a("#preview img").attr("title",b.select),a("#preview img").click(function(){D(c)}).css("cursor","pointer")}else a("#fileinfo").find("button#select").hide();r(c,"rename")?a("#fileinfo").find("button#rename").click(function(){var b=K(c);b.length&&a("#fileinfo > h1").text(b)}).show():a("#fileinfo").find("button#rename").hide();
r(c,"move")?a("#fileinfo").find("button#move").click(function(){var b=L(c);b.length&&a("#fileinfo > h1").text(b)}).show():a("#fileinfo").find("button#move").hide();r(c,"replace")?a("#fileinfo").find("button#replace").click(function(){M(c)}).show():a("#fileinfo").find("button#replace").hide();r(c,"delete")?a("#fileinfo").find("button#delete").click(function(){N(c)&&a("#fileinfo").html("<h1>"+b.select_from_left+"</h1>")}).show():a("#fileinfo").find("button#delete").hide();r(c,"download")?a("#fileinfo").find("button#download").click(function(){window.location=
...
g):(parent.CKEDITOR.tools.callFunction(a.urlParam("CKEditorFuncNum"),g),parent.CKEDITOR.tools.callFunction(a.urlParam("CKEditorCleanUpFuncNum"))):""!=c.Properties.Width?window.opener.SetUrl(g,c.Properties.Width,c.Properties.Height):window.opener.SetUrl(g),window.opener&&window.close()):a.prompt(b.fck_select_integration)},K=function(c){var g="",e=f.security.allowChangeExtensions?c.Filename:T(c.Filename),e=b.new_filename+' : <input id="rname" name="rname" type="text" value="'+e+'" />',d={};d[b.rename]=
!0;d[b.cancel]=!1;a.prompt(e,{callback:function(d,e){if(1!=d)return!1;rname=e.children("#rname").val();if(""!=rname){var h=rname;if(!f.security.allowChangeExtensions){var h=S(rname),l=q(c.Filename);0<l.length&&(h=h+"."+l)}if("/"!=c.Path.charAt(c.Path.length-1)&&!J(h))return h="<p>"+b.INVALID_FILE_TYPE+"</p>","DISALLOW_ALL"==f.security.uploadPolicy&&(h+="<p>"+b.ALLOWED_FILE_TYPE+f.security.uploadRestrictions.join(", ")+".</p>"),"ALLOW_ALL"==f.security.uploadPolicy&&(h+="<p>"+b.DISALLOWED_FILE_TYPE+
...
0==c.Code?(c=c.Path+"/"+c.Name,E(c),a("#preview").find("img").hide().fadeIn("slow"),a("ul.jqueryFileTree").find('li a[data-path="'+c+'"]').parent().hide().fadeIn("slow"),f.options.showConfirmation&&a.prompt(b.successful_replace)):a.prompt(c.Error);a("#replace").removeAttr("disabled");a("#upload span").removeClass("loading").text(b.upload)}});a("#newfilepath").val(c.Path);a("#fileR").click()},L=function(c){var g="",e=b.move+' : <input id="rname" name="rname" type="text" value="" />',e=e+('<div class="prompt-info">'+
...
g=c+e}})}},buttons:d});return g},N=function(c){var g=!1,e=b.confirmation_delete,d={};d[b.yes]=!0;d[b.no]=!1;a.prompt(e,{callback:function(d,e){if(1!=d)return!1;var h=new Date,h=k+"?mode=delete&path="+encodeURIComponent(c.Path)+"&time="+h.getMilliseconds()+"&config="+userconfig,l=c.Path.split("/").reverse().slice(1).reverse().join("/")+"/";a.ajax({type:"GET",url:h,dataType:"json",async:!1,success:function(d){0==d.Code?(aa(d.Path),d=d.Path.substring(0,d.Path.length-1),d=d.substr(0,d.lastIndexOf("/")+
...
a("#filetree").find('li a[data-path="'+c+g+'/"]').attr("class","cap_rename cap_delete").click(function(){m(c+g+"/")}).each(function(){a(this).contextMenu({menu:v(a(this))},function(d,b,c){b=a(b).attr("data-path");z(d,b)})}));f.options.showConfirmation&&a.prompt(b.successful_added_folder)},G=function(b){b.lastIndexOf("/")==b.length-1?(m(b),a("#filetree").find('a[data-path="'+b+'"]').click()):E(b)},z=function(b,f){var e=new Date;a.getJSON(k+"?mode=getinfo&path="+f+"&config="+userconfig+"&time="+e.getMilliseconds(),
function(d){"grid"==a("#fileinfo").data("view")?a("#fileinfo").find('img[data-path="'+d.Path+'"]').parent():a("#fileinfo").find('td[data-path="'+d.Path+'"]').parent();switch(b){case "select":D(d);break;case "download":window.location=k+"?mode=download&path="+d.Path+"&config="+userconfig+"&time="+e.getMilliseconds();break;case "rename":K(d);break;case "replace":M(d);break;case "move":L(d);break;case "delete":N(d)}})},E=function(c){a(".contextMenu").hide();var g=c.substr(0,c.lastIndexOf("/")+1);C(g);
...
b.size+"</dt><dd>"+H(d.Properties.Size)+"</dd>";a("#fileinfo").find("dl").html(e);O(d)}else a.prompt(d.Error)})},m=function(c){C(c);var g='<img id="activity" src="themes/'+f.options.theme+'/images/wait30trans.gif" width="30" height="30" />';0<a("#fileinfo .mCSB_container").length?a("#fileinfo .mCSB_container").html(g):a("#fileinfo").html(g);a("#loading-wrap").fadeOut(800);g=new Date;c=k+"?path="+encodeURIComponent(c)+"&config="+userconfig+"&mode=getfolder&showThumbs="+f.options.showThumbs+"&time="+
g.getMilliseconds();a.urlParam("type")&&(c+="&type="+a.urlParam("type"));a.getJSON(c,function(c){var d="";if("-1"==c.Code)I(c.Error);else{x();if(c){var g=0,p=0;if("grid"==a("#fileinfo").data("view")){d+='<ul id="contents" class="grid">';for(key in c){g++;var h=c[key].Properties,l="";for(cap in n)r(c[key],n[cap])&&(l+=" cap_"+n[cap]);var F=64,k=h.Width;1<k&&k<F&&(F=k);f.options.showTitleAttr?title=' title="'+c[key].Path+'"':title="";d+='<li class="'+l+'"'+title+'"><div class="clip"><img src="'+c[key].Preview+
'" width="'+F+'" alt="'+c[key].Path+'" data-path="'+c[key].Path+'" /></div><p>'+c[key].Filename+"</p>";h.Width&&""!=h.Width&&(d+='<span class="meta dimensions">'+h.Width+"x"+h.Height+"</span>");h.Size&&""!=h.Size&&(d+='<span class="meta size">'+h.Size+"</span>");h.Size&&""!=h.Size&&(p+=h.Size);h["Date Created"]&&""!=h["Date Created"]&&(d+='<span class="meta created">'+h["Date Created"]+"</span>");h["Date Modified"]&&""!=h["Date Modified"]&&(d+='<span class="meta modified">'+h["Date Modified"]+"</span>");
...
a.urlParam("expandedFolder"),fullexpandedFolder=fileRoot+expandedFolder):(expandedFolder="",fullexpandedFolder=null);a("#folder-info").html('<span id="items-counter"></span> '+b.items+" - "+b.size+' : <span id="items-size"></span> '+b.mb);1==f.options.autoload&&(a("#upload").append(b.upload),a("#newfolder").append(b.new_folder),a("#grid").attr("title",b.grid_view),a("#list").attr("title",b.list_view),a("#fileinfo h1").append(b.select_from_left),a('#itemOptions a[href$="#select"]').append(b.select),
a('#itemOptions a[href$="#download"]').append(b.download),a('#itemOptions a[href$="#rename"]').append(b.rename),a('#itemOptions a[href$="#move"]').append(b.move),a('#itemOptions a[href$="#replace"]').append(b.replace),a('#itemOptions a[href$="#delete"]').append(b.del));a.urlParam("CKEditorCleanUpFuncNum")&&(a("body").append('<button id="close-btn" type="button">'+b.close+"</button>"),a("#close-btn").click(function(){parent.CKEDITOR.tools.callFunction(a.urlParam("CKEditorCleanUpFuncNum"))}));a("#browse").append("+");
a("#browse").attr("title",b.browse);a("#newfile").change(function(){a("#filepath").val(a(this).val().replace(/.+[\\\/]/,""))});!0===f.options.searchBox?loadJS("./scripts/filemanager.liveSearch.min.js"):a("#search").remove();a("button").wrapInner("<span></span>");a("#fileinfo").data("view",f.options.defaultViewMode);A(f.options.defaultViewMode);a("#home").click(function(){var b=a("#fileinfo").data("view");a("#fileinfo").data("view",b);a("#filetree ul.jqueryFileTree > li.expanded > a").trigger("click");
m(fileRoot)});a("#level-up").click(function(){var b=a("#uploader h1").attr("data-path");if(b!=fileRoot){parent=b.substring(0,b.slice(0,-1).lastIndexOf("/"))+"/";var c=a("#fileinfo").data("view");a("#fileinfo").data("view",c);a("#filetree").find('a[data-path="'+b+'"]').click();m(parent)}});a("#grid").click(function(){A("grid");a("#fileinfo").data("view","grid");m(a("#currentpath").val())});a("#list").click(function(){A("list");a("#fileinfo").data("view","list");m(a("#currentpath").val())});C(fileRoot);
...
a("#upload").remove(),a("#newfolder").remove(),a("#toolbar").remove("#rename"),a(".contextMenu .rename").remove(),a(".contextMenu .move").remove(),a(".contextMenu .replace").remove(),a(".contextMenu .delete").remove());x();a(window).resize(x);a("#splitter").splitter({sizeLeft:200,minLeft:200,minRight:200});G(fileRoot+expandedFolder)});document.documentElement.setAttribute("data-useragent",navigator.userAgent);f.options.logger&&(w=(new Date).getTime()-R,console.log("Total execution time : "+w+" ms"));
a(window).load(function(){x()})})(jQuery);$(window).load(function(){$("#fileinfo").css({left:$("#splitter .vsplitbar").width()+$("#filetree").width()})});
