...
if(!a("#"+e).length){var d=a("#itemOptions").clone().attr("id",e);b.hasClass("cap_select")||a(".select",d).remove();b.hasClass("cap_download")||a(".download",d).remove();b.hasClass("cap_rename")||a(".rename",d).remove();b.hasClass("cap_move")||a(".move",d).remove();a(".replace",d).remove();b.hasClass("cap_delete")||a(".delete",d).remove();a("#itemOptions").after(d)}return e}a.urlParam=function(a){return(a=(new RegExp("[\\?&]"+a+"=([^&#]*)")).exec(window.location.href))?a[1]:0};var v=function(b){var e=
null;"user"==("undefined"===typeof b?"user":b)?0!=a.urlParam("config")?(b="./scripts/"+a.urlParam("config"),userconfig=a.urlParam("config")):(b="./scripts/filemanager.config.js",userconfig="filemanager.config.js"):b="./scripts/filemanager.config.js.default";a.ajax({async:!1,url:b,dataType:"json",cache:!1,success:function(a){e=a}});return e},R=v("default"),f=v();null!==f&&delete f.version;f=a.extend({},R,f);if(f.options.logger)var B=(new Date).getTime();HEAD_included_files=[];loadCSS=function(b){if(-1==
...
d+" -  pos : "+c+" - returned value : "+rvalue);return rvalue};var k=f.options.fileConnector||"connectors/"+f.options.lang+"/filemanager."+f.options.lang,n=f.options.capabilities||"select download rename move delete replace".split(" ");0!=a.urlParam("langCode")&&(I("scripts/languages/"+a.urlParam("langCode")+".js")?f.options.culture=a.urlParam("langCode"):(v=a.urlParam("langCode").substring(0,2),I("scripts/languages/"+v+".js")&&(f.options.culture=v)));var g=[];a.ajax({url:"scripts/languages/"+f.options.culture+
...
typeof displayPathDecorator)return displayPathDecorator(a.replace(fileRoot,"/"));a=a.replace(fileRoot,"/");if(50<a.length&&!0===e){var d=a.split("/");a="/"+d[1]+"/"+d[2]+"/(...)/"+d[d.length-2]+"/"}}return a},C=function(b){"grid"==b?(a("#grid").addClass("ON"),a("#list").removeClass("ON")):(a("#list").addClass("ON"),a("#grid").removeClass("ON"))},D=function(a){var e="",e="\u0160\u0161\u0110\u0111\u017d\u017e\u010c\u010d\u0106\u0107\u00c0\u00c1\u00c2\u00c3\u00c4\u00c5\u00c6\u00c7\u00c8\u00c9\u00ca\u00cb\u00cc\u00cd\u00ce\u00cf\u00d1\u00d2\u00d3\u00d4\u00d5\u00d6\u0150\u00d8\u00d9\u00da\u00db\u00dc\u00dd\u00de\u00df\u00e0\u00e1\u00e2\u00e3\u00e4\u00e5\u00e6\u00e7\u00e8\u00e9\u00ea\u00eb\u00ec\u00ed\u00ee\u00ef\u00f0\u00f1\u00f2\u00f3\u00f4\u00f5\u00f6\u0151\u00f8\u00f9\u00fa\u00fb\u00fc\u00fd\u00fd\u00fe\u00ff\u0154\u0155 '/".split(""),
d="S s Dj dj Z z C c C c A A A A A A A C E E E E I I I I N O O O O O O O U U U U Y B Ss a a a a a a a c e e e e i i i i o n o o o o o o o u u u u y y b y R r _ _ ".split(" ");a=String(a);for(i=0;i<e.length;i++)a=a.replace(RegExp(e[i],"g"),d[i]);e=a;f.options.chars_only_latin&&(e=e.replace(/[^_a-zA-Z0-9]/g,""));return e=e.replace(/[_]+/g,"_")},S=function(a){filename="";-1!=a.lastIndexOf(".")?(filename=D(a.substr(0,a.lastIndexOf("."))),filename+="."+a.split(".").pop()):filename=D(a);return filename},
J=function(a){a=parseFloat(a);for(var e=0,d=[g.bytes,g.kb,g.mb,g.gb];;){if(1024>a)return a=Math.round(100*a)/100,a+d[e];a/=1024;e+=1}},K=function(b){a("#fileinfo").html("<h1>"+b+"</h1>");a("#newfile").attr("disabled","disabled");a("#upload").attr("disabled","disabled");a("#newfolder").attr("disabled","disabled")},L=function(b){b=q(b);return""==b&&1==f.security.allowNoExtension||"DISALLOW_ALL"==f.security.uploadPolicy&&-1!=a.inArray(b,f.security.uploadRestrictions)||"ALLOW_ALL"==f.security.uploadPolicy&&
-1==a.inArray(b,f.security.uploadRestrictions)?!0:!1},q=function(a){return 1==a.split(".").length?"":a.split(".").pop().toLowerCase()},T=function(a){return-1!=a.lastIndexOf(".")?a.substring(0,a.lastIndexOf(".")):a},U=function(b){var e="<video width="+f.videos.videosPlayerWidth+" height="+f.videos.videosPlayerHeight+' src="'+b.Path+'" controls="controls">',e=e+('<img src="'+b.Preview+'" />'),e=e+"</video>";a("#fileinfo img").remove();a("#fileinfo #preview #main-title").before(e)},V=function(b){var e=
'<audio src="'+b.Path+'" controls="controls">',e=e+('<img src="'+b.Preview+'" />'),e=e+"</audio>";a("#fileinfo img").remove();a("#fileinfo #preview #main-title").before(e)},W=function(b){b='<iframe id="fm-pdf-viewer" src = "scripts/ViewerJS/index.html#'+b.Path+'" width="'+f.pdfs.pdfsReaderWidth+'" height="'+f.pdfs.pdfsReaderHeight+'" allowfullscreen webkitallowfullscreen></iframe>';a("#fileinfo img").remove();a("#fileinfo #preview #main-title").before(b)},X=function(b){a("#fileinfo").find("td:first-child").each(function(){var e=
a(this).attr("data-path"),e=a("#filetree").find('a[data-path="'+e+'"]').parent();"undefined"!==typeof e.css("background-image")&&(a(this).css("background-image",e.css("background-image")),window.clearInterval(b))})},E=function(b){a("#currentpath").val(b);a("#uploader h1").text(g.current_folder+z(b)).attr("title",z(b,!1)).attr("data-path",b);a("#newfolder").unbind().click(function(){var b=g.default_foldername,d=g.prompt_foldername+' : <input id="fname" name="fname" type="text" value="'+b+'" />',c=
{};c[g.create_folder]=!0;c[g.cancel]=!1;a.prompt(d,{callback:function(c,d){if(1!=c)return!1;var f=d.children("#fname").val();""!=f?(b=D(f),f=new Date,a.getJSON(k+"?mode=addfolder&path="+a("#currentpath").val()+"&config="+userconfig+"&name="+encodeURIComponent(b)+"&time="+f.getMilliseconds(),function(c){0==c.Code?(Y(c.Parent,c.Name),m(c.Parent),a("#filetree").find('a[data-path="'+c.Parent+'/"]').click().click()):a.prompt(c.Error)})):a.prompt(g.no_foldername)},buttons:c})})},Q=function(b){a("#fileinfo button").each(function(b){0==
a(this).find("span").length&&a(this).wrapInner("<span></span>")});if(r(b,"select")){if(a("#fileinfo").find("button#select").click(function(){w(b)}).show(),window.opener||window.tinyMCEPopup)a("#preview img").attr("title",g.select),a("#preview img").click(function(){w(b)}).css("cursor","pointer")}else a("#fileinfo").find("button#select").hide();r(b,"rename")?a("#fileinfo").find("button#rename").click(function(){var e=M(b);e.length&&a("#fileinfo > h1").text(e)}).show():a("#fileinfo").find("button#rename").hide();
r(b,"move")?a("#fileinfo").find("button#move").click(function(){var e=N(b);e.length&&a("#fileinfo > h1").text(e)}).show():a("#fileinfo").find("button#move").hide();r(b,"replace")?a("#fileinfo").find("button#replace").click(function(){O(b)}).show():a("#fileinfo").find("button#replace").hide();r(b,"delete")?a("#fileinfo").find("button#delete").click(function(){P(b)&&a("#fileinfo").html("<h1>"+g.select_from_left+"</h1>")}).show():a("#fileinfo").find("button#delete").hide();r(b,"download")?a("#fileinfo").find("button#download").click(function(){window.location=
k+"?mode=download&path="+encodeURIComponent(b.Path)+"&config="+userconfig}).show():a("#fileinfo").find("button#download").hide()},u=function(){var b=0<a("#filetree .mCSB_container").length?"#filetree .mCSB_container":"#filetree";a(b).fileTree({root:fileRoot,datafunc:Z,multiFolder:!1,folderCallback:function(a){m(a)},expandedFolder:fullexpandedFolder,after:function(b){a("#filetree").find("li a").each(function(){a(this).contextMenu({menu:x(a(this))},function(b,c,e){c=a(c).attr("data-path");A(b,c)})});
1==f.options.searchBox&&(a("#q").liveUpdate("#filetree ul").blur(),a("#search span.q-inactive").html(g.search),a("#search a.q-reset").attr("title",g.search_reset))}},function(a){F(a)})},w=function(b){var e=!1!==f.options.baseUrl?smartPath(baseUrl,b.Path.replace(fileRoot,"")):b.Path;window.opener||window.tinyMCEPopup||a.urlParam("field_name")||a.urlParam("CKEditorCleanUpFuncNum")||a.urlParam("CKEditor")?window.tinyMCEPopup?(b=tinyMCEPopup.getWindowArg("window"),b.document.getElementById(tinyMCEPopup.getWindowArg("input")).value=
...
e):(parent.CKEDITOR.tools.callFunction(a.urlParam("CKEditorFuncNum"),e),parent.CKEDITOR.tools.callFunction(a.urlParam("CKEditorCleanUpFuncNum"))):""!=b.Properties.Width?window.opener.SetUrl(e,b.Properties.Width,b.Properties.Height):window.opener.SetUrl(e),window.opener&&window.close()):a.prompt(g.fck_select_integration)},M=function(b){var e="",d=f.security.allowChangeExtensions?b.Filename:T(b.Filename),d=g.new_filename+' : <input id="rname" name="rname" type="text" value="'+d+'" />',c={};c[g.rename]=
!0;c[g.cancel]=!1;a.prompt(d,{callback:function(c,d){if(1!=c)return!1;rname=d.children("#rname").val();if(""!=rname){var h=rname;if(!f.security.allowChangeExtensions){var h=S(rname),l=q(b.Filename);0<l.length&&(h=h+"."+l)}if("/"!=b.Path.charAt(b.Path.length-1)&&!L(h))return h="<p>"+g.INVALID_FILE_TYPE+"</p>","DISALLOW_ALL"==f.security.uploadPolicy&&(h+="<p>"+g.ALLOWED_FILE_TYPE+f.security.uploadRestrictions.join(", ")+".</p>"),"ALLOW_ALL"==f.security.uploadPolicy&&(h+="<p>"+g.DISALLOWED_FILE_TYPE+
f.security.uploadRestrictions.join(", ")+".</p>"),a("#filepath").val(""),a.prompt(h),!1;h=k+"?mode=rename&old="+encodeURIComponent(b.Path)+"&new="+encodeURIComponent(h)+"&config="+userconfig;a.ajax({type:"GET",url:h,dataType:"json",async:!1,success:function(c){if(0==c.Code){var d=c["New Path"],t=c["New Name"],h=c["Old Path"],p=a("#filetree").find('a[data-path="'+h+'"]'),l=p.parent().parent().prev("a");p.attr("data-path",d).text(t);0==l.length?u():l.click().click();p=a("#preview h1").attr("title");
"undefined"!=typeof p&&p==h&&a("#preview h1").text(t);"grid"==a("#fileinfo").data("view")?(a('#fileinfo img[data-path="'+h+'"]').parent().next("p").text(t),a('#fileinfo img[data-path="'+h+'"]').attr("data-path",d)):(a('#fileinfo td[data-path="'+h+'"]').text(t),a('#fileinfo td[data-path="'+h+'"]').attr("data-path",d));a("#preview h1").html(t);b.Path=d;b.Filename=t;a("#fileinfo").find("button#rename, button#delete, button#download").unbind();Q(b);f.options.showConfirmation&&a.prompt(g.successful_rename)}else a.prompt(c.Error);
e=c["New Name"]}})}},buttons:c});return e},O=function(b){a("#fileR").bind("change",function(){a(this).closest("form#toolbar").submit()});a("#toolbar").attr("action",k);a("#toolbar").attr("method","post");a("#toolbar").ajaxForm({target:"#uploadresponse",beforeSubmit:function(e,d,c){e=a("#fileR",d).val();if(""==e)return!1;if(q(e)!=b["File Type"])return a.prompt(g.ERROR_REPLACING_FILE+" ."+q(b.Filename)),!1;a("#replace").attr("disabled",!0);a("#upload span").addClass("loading").text(g.loading_data);
...
jQuery.parseJSON(a("#uploadresponse").find("textarea").text());0==b.Code?(b=b.Path+"/"+b.Name,F(b),a("#preview").find("img").hide().fadeIn("slow"),a("ul.jqueryFileTree").find('li a[data-path="'+b+'"]').parent().hide().fadeIn("slow"),f.options.showConfirmation&&a.prompt(g.successful_replace)):a.prompt(b.Error);a("#replace").removeAttr("disabled");a("#upload span").removeClass("loading").text(g.upload)}});a("#newfilepath").val(b.Path);a("#fileR").click()},N=function(b){var e="",d=g.move+' : <input id="rname" name="rname" type="text" value="" />',
d=d+('<div class="prompt-info">'+g.help_move+"</div>"),c={};c[g.move]=!0;c[g.cancel]=!1;a.prompt(d,{callback:function(c,d){if(1!=c)return!1;rname=d.children("#rname").val();if(""!=rname){var h=rname,h=k+"?mode=move&old="+encodeURIComponent(b.Path)+"&new="+encodeURIComponent(h)+"&root="+encodeURIComponent(fileRoot)+"&config="+userconfig;a.ajax({type:"GET",url:h,dataType:"json",async:!1,success:function(c){if(0==c.Code){var b=c["New Path"],d=c["New Name"];fullexpandedFolder=b;u();m(b);f.options.showConfirmation&&
a.prompt(g.successful_moved)}else a.prompt(c.Error);e=b+d}})}},buttons:c});return e},P=function(b){var e=!1,d=g.confirmation_delete,c={};c[g.yes]=!0;c[g.no]=!1;a.prompt(d,{callback:function(c,d){if(1!=c)return!1;var h=new Date,h=k+"?mode=delete&path="+encodeURIComponent(b.Path)+"&time="+h.getMilliseconds()+"&config="+userconfig,l=b.Path.split("/").reverse().slice(1).reverse().join("/")+"/";a.ajax({type:"GET",url:h,dataType:"json",async:!1,success:function(c){0==c.Code?(aa(c.Path),c=c.Path.substring(0,
...
(a("#filetree ul.jqueryFileTree").prepend(d),a("#filetree").find('li a[data-path="'+b+e+'/"]').attr("class","cap_rename cap_delete").click(function(){m(b+e+"/")}).each(function(){a(this).contextMenu({menu:x(a(this))},function(c,b,d){b=a(b).attr("data-path");A(c,b)})}));f.options.showConfirmation&&a.prompt(g.successful_added_folder)},H=function(b){b.lastIndexOf("/")==b.length-1?(m(b),a("#filetree").find('a[data-path="'+b+'"]').click()):F(b)},A=function(b,f){var d=new Date;a.getJSON(k+"?mode=getinfo&path="+
encodeURIComponent(f)+"&config="+userconfig+"&time="+d.getMilliseconds(),function(c){"grid"==a("#fileinfo").data("view")?a("#fileinfo").find('img[data-path="'+c.Path+'"]').parent():a("#fileinfo").find('td[data-path="'+c.Path+'"]').parent();switch(b){case "select":w(c);break;case "download":window.location=k+"?mode=download&path="+c.Path+"&config="+userconfig+"&time="+d.getMilliseconds();break;case "rename":M(c);break;case "replace":O(c);break;case "move":N(c);break;case "delete":P(c)}})},F=function(b){a(".contextMenu").hide();
var e=b.substr(0,b.lastIndexOf("/")+1);E(e);var d;d='<div id="preview"><img /><div id="main-title"><h1></h1><div id="tools"></div></div><dl></dl></div><form id="toolbar">'+('<button id="parentfolder">'+g.parentfolder+"</button>");-1!=a.inArray("select",n)&&(a.urlParam("CKEditor")||window.opener||window.tinyMCEPopup||a.urlParam("field_name"))&&(d+='<button id="select" name="select" type="button" value="Select">'+g.select+"</button>");-1!=a.inArray("download",n)&&(d+='<button id="download" name="download" type="button" value="Download">'+
...
g.size+"</dt><dd>"+J(c.Properties.Size)+"</dd>";a("#fileinfo").find("dl").html(d);Q(c)}else a.prompt(c.Error)})},m=function(b){E(b);var e='<img id="activity" src="themes/'+f.options.theme+'/images/wait30trans.gif" width="30" height="30" />';0<a("#fileinfo .mCSB_container").length?a("#fileinfo .mCSB_container").html(e):a("#fileinfo").html(e);a("#loading-wrap").fadeOut(800);e=new Date;b=k+"?path="+encodeURIComponent(b)+"&config="+userconfig+"&mode=getfolder&showThumbs="+f.options.showThumbs+"&time="+
e.getMilliseconds();a.urlParam("type")&&(b+="&type="+a.urlParam("type"));a.getJSON(b,function(b){var c="";if("-1"==b.Code)K(b.Error);else{y();if(b){var e=0,p=0;if("grid"==a("#fileinfo").data("view")){c+='<ul id="contents" class="grid">';for(key in b){e++;var h=b[key].Properties,l="";for(cap in n)r(b[key],n[cap])&&(l+=" cap_"+n[cap]);var G=64,k=h.Width;1<k&&k<G&&(G=k);f.options.showTitleAttr?title=' title="'+b[key].Path+'"':title="";c+='<li class="'+l+'"'+title+'"><div class="clip"><img src="'+b[key].Preview+
'" width="'+G+'" alt="'+b[key].Path+'" data-path="'+b[key].Path+'" /></div><p>'+b[key].Filename+"</p>";h.Width&&""!=h.Width&&(c+='<span class="meta dimensions">'+h.Width+"x"+h.Height+"</span>");h.Size&&""!=h.Size&&(c+='<span class="meta size">'+h.Size+"</span>");h.Size&&""!=h.Size&&(p+=h.Size);h["Date Created"]&&""!=h["Date Created"]&&(c+='<span class="meta created">'+h["Date Created"]+"</span>");h["Date Modified"]&&""!=h["Date Modified"]&&(c+='<span class="meta modified">'+h["Date Modified"]+"</span>");
...
b[key].Filename+"</td>";c=h.Width&&""!=h.Width?c+("<td>"+h.Width+"x"+h.Height+"</td>"):c+"<td></td>";h.Size&&""!=h.Size?(c+='<td><abbr title="'+h.Size+'">'+J(h.Size)+"</abbr></td>",p+=h.Size):c+="<td></td>";c=h["Date Modified"]&&""!=h["Date Modified"]?c+("<td>"+h["Date Modified"]+"</td>"):c+"<td></td>";c+="</tr>"}c+="</tbody>";c+="</table>"}}else c+="<h1>"+g.could_not_retrieve_folder+"</h1>";0<a("#fileinfo .mCSB_container").length?a("#fileinfo .mCSB_container").html(c):a("#fileinfo").html(c);a("#items-counter").text(e);
a("#items-size").text(Math.round(p/1024/1024*100)/100);if("grid"==a("#fileinfo").data("view"))a("#fileinfo").find("#contents li").click(function(){var c=a(this).find("img").attr("data-path");f.options.quickSelect&&"dir"!=b[c]["File Type"]&&a(this).hasClass("cap_select")?w(b[c]):H(c)}).each(function(){a(this).contextMenu({menu:x(a(this))},function(c,b,d){b=a(b).find("img").attr("data-path");A(c,b)})});else{a("#fileinfo tbody tr").click(function(){var c=a("td:first-child",this).attr("data-path");f.options.quickSelect&&
"dir"!=b[c]["File Type"]&&a(this).hasClass("cap_select")?w(b[c]):H(c)}).each(function(){a(this).contextMenu({menu:x(a(this))},function(c,b,d){b=a("td:first-child",b).attr("data-path");A(c,b)})});a("#fileinfo").find("table").tablesorter({textExtraction:function(c){return a(c).find("abbr").size()?a(c).find("abbr").attr("title"):c.innerHTML}});var m=setInterval(function(){X(m)},300)}}})},Z=function(b,e){var d=new Date,d=k+"?path="+encodeURIComponent(b)+"&config="+userconfig+"&mode=getfolder&showThumbs="+
f.options.showThumbs+"&time="+d.getMilliseconds();a.urlParam("type")&&(d+="&type="+a.urlParam("type"));a.getJSON(d,function(a){var b="";if("-1"==a.Code)K(a.Error);else{if(a){b+='<ul class="jqueryFileTree" style="display: none;">';for(key in a){var d="";for(cap in n)r(a[key],n[cap])&&(d+=" cap_"+n[cap]);if("dir"==a[key]["File Type"])var h=0==a[key].Protected?"":" directory-locked",b=b+('<li class="directory collapsed'+h+'"><a href="#" class="'+d+'" data-path="'+a[key].Path+'">'+a[key].Filename+"</a></li>");
...
a("#fileinfo").data("view",f.options.defaultViewMode);C(f.options.defaultViewMode);a("#home").click(function(){var b=a("#fileinfo").data("view");a("#fileinfo").data("view",b);a("#filetree ul.jqueryFileTree > li.expanded > a").trigger("click");m(fileRoot)});a("#level-up").click(function(){var b=a("#uploader h1").attr("data-path");if(b!=fileRoot){parent=b.substring(0,b.slice(0,-1).lastIndexOf("/"))+"/";var d=a("#fileinfo").data("view");a("#fileinfo").data("view",d);a("#filetree").find('a[data-path="'+
b+'"]').click();m(parent)}});a("#grid").click(function(){C("grid");a("#fileinfo").data("view","grid");m(a("#currentpath").val())});a("#list").click(function(){C("list");a("#fileinfo").data("view","list");m(a("#currentpath").val())});E(fileRoot);f.upload.multiple?(loadCSS("./scripts/dropzone/downloads/css/dropzone.css"),loadJS("./scripts/dropzone/downloads/dropzone.js"),Dropzone.autoDiscover=!1,a("#file-input-container").remove(),a("#upload").remove(),a("#newfolder").before('<button value="Upload" type="button" name="upload" id="upload" class="em"><span>'+
...
!1===error_flag&&setTimeout(function(){a.prompt.close()},800),m(d),d==fileRoot&&u(),a("#filetree").find('a[data-path="'+d+'"]').click().click(),f.options.showConfirmation&&a.prompt(g.successful_added_file))}})})):(a("#uploader").attr("action",k+"?config="+userconfig),a("#uploader").ajaxForm({target:"#uploadresponse",beforeSubmit:function(b,d,e){if(""==a("#newfile",d).val())return!1;if(!L(a("#newfile",d).val()))return d="<p>"+g.INVALID_FILE_TYPE+"</p>","DISALLOW_ALL"==f.security.uploadPolicy&&(d+=
...
minLeft:f.options.splitterMinWidth,minRight:200});H(fileRoot+expandedFolder)});document.documentElement.setAttribute("data-useragent",navigator.userAgent);f.options.logger&&(B=(new Date).getTime()-B,console.log("Total execution time : "+B+" ms"));a(window).load(function(){y()})})(jQuery);$(window).load(function(){$("#fileinfo").css({left:$("#splitter .vsplitbar").width()+$("#filetree").width()})});
