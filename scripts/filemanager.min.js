/*
 ...
 @copyright	Authors
*/
(function(a){function O(a){var c=this.window.ActiveXObject?new ActiveXObject("Microsoft.XMLHTTP"):new XMLHttpRequest;if(!c)throw Error("XMLHttpRequest not supported");c.open("HEAD",a,!1);c.send(null);return 200==c.status?!0:!1}function p(b,c){return"dir"==b["File Type"]&&"replace"==c?!1:"dir"==b["File Type"]&&"download"==c?1==g.security.allowFolderDownload?!0:!1:"undefined"==typeof b.Capabilities?!0:-1<a.inArray(c,b.Capabilities)}function t(b){var c=b.attr("class").replace(/ /g,"_");if(""==c)return"itemOptions";
if(!a("#"+c).length){var d=a("#itemOptions").clone().attr("id",c);b.hasClass("cap_select")||a(".select",d).remove();b.hasClass("cap_download")||a(".download",d).remove();b.hasClass("cap_rename")||a(".rename",d).remove();b.hasClass("cap_move")||a(".move",d).remove();a(".replace",d).remove();b.hasClass("cap_delete")||a(".delete",d).remove();a("#itemOptions").after(d)}return c}a.urlParam=function(a){return(a=(new RegExp("[\\?&]"+a+"=([^&#]*)")).exec(window.location.href))?a[1]:0};var u=function(b){var c=
