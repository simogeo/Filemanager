...
class Filemanager {
  ...
  public function __construct($config) {
    $this->config = $config;
    if (!file_exists($this->config['rsc-php-cloudfiles-path'].'cloudfiles.php')) {
    	die("Missing cloudfiles API package... check the config key 'rsc-php-cloudfiles-path' = [{$this->config['rsc-php-cloudfiles-path']}]");
    }
    require_once($this->config['rsc-php-cloudfiles-path'].'cloudfiles.php');
